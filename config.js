module.exports = {
	...
	adminId: "311471678112661504", //- Replace UserId with the Discord ID of the admin of the bot
	...
	supportServer: "https://discord.gg/AgXYVAzHYh", //- Support Server Link
	Issues: "https://discord.gg/AgXYVAzHYh", //- Bug Report Link
	...
	cookieSecret: "koki", //- Cookie Secret
	...
	nodes: [
		{
			...
			host: "node.kuzaken.tech", //- The host name or IP of the lavalink server.
			port: 4097, // The port that lavalink is listening to. This must be a number!
			password: "node.kuzaken.tech", //- The password of the lavalink server.
